    ...
    <main className={`${bodySans.className} bg-[#fbfaf8] text-[#3d4047]`}>
      ...
      <section className="bg-[#fbfaf8] px-6 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            Bez obzira da li 18. rođendan proslavljate u restoranu, sali ili u
      ...
      <section className="bg-[#fbfaf8] px-6 pb-16 md:pb-24">
        <div className="mx-auto max-w-5xl rounded-t-[34px] bg-[#fbfaf8] px-6 pt-6 md:px-10">
          <TitleBlock title="Dekoracije za 18. rođendan u Somboru i okolini" />

          <div className="mx-auto mt-10 max-w-4xl space-y-8 text-[25px] leading-[1.8] text-[#474a51] md:text-[30px]">
            <p>
              Ovo je godina kada svi organizuju punoletstva, a sigurni smo da želite
              da se <strong>vaša proslava bar malo razlikuje od ostalih.</strong>
              Jedan od najboljih načina da se izdvojite i da vaš rođendan ostane
      ...
      <section className="bg-[#edf1f3] px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl text-center">
          <TitleBlock title="Kompletna dekoracija za punoletstvo" />

          <div className="mx-auto mt-10 max-w-4xl space-y-8 text-[24px] leading-[1.8] text-[#4a4d54] md:text-[29px]">
            <p>
              Svako punoletstvo je jedinstveno, zato uvek
              {" "}
              <strong>kreiramo personalizovane ponude</strong>
              {" "}
              po meri slavljenika ili slavljenice. U obzir uzimamo prostor,
          ...
          <div className="px-6 py-16 md:px-12 md:py-20">
            ...
            <div className="mt-10 max-w-4xl space-y-8 text-[24px] leading-[1.8] text-[#4a4d54] md:text-[29px]">
              <p>
                ...
                ali je važno znati kako sve te ideje pretvoriti u skladnu i elegantnu celinu.
                Potrebno je imati dobar pravac, temu i osećaj za meru.
              </p>

              <p>
                Velika prednost je što naš tim pored same izrade može pomoći
                savetima i konkretnim predlozima, kako bi dekoracija delovala ozbiljno,
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:px-12 md:py-20">
          ...
          <div className="mt-10 max-w-4xl space-y-8 text-[24px] leading-[1.8] text-[#4a4d54] md:text-[29px]">
            <p>
              ...
              potpuno razumljivo. Kod devojaka uglavnom
              {" "}
            ...
            <p>
              ...
              jeste ubacivanje dodatnih sadržaja — kutka za slikanje, personalizovanih
              detalja, svetlećih elemenata i drugih finih akcenata koji doprinose
              luksuznijem utisku.
            </p>
          </div>
        </div>
      ...
      <section className="bg-[#eef2f4] px-6 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-[24px] leading-[1.9] text-[#444850] md:text-[29px]">
            Dekoracija i{" "}
            <span className="text-[#d1a9b7]">organizacija 18. rođendana</span>{" "}
            sa sobom nose mnogo pitanja, a najbolji način da dođete do pravog
            odgovora jeste razgovor sa ljudima koji imaju iskustva. Tim Magic Moments
            vam stoji na raspolaganju za sva pitanja u vezi organizacije, dekoracije,
            naših usluga i paketa.
          </p>
