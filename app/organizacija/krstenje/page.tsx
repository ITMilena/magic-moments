export default function KrstenjePage() {
  ...
  const highlights = [
    {
      title: "Svečana i nežna atmosfera",
      text: "Kreiramo proslavu krštenja sa merom, elegancijom i toplinom, uz pažljivo usklađene detalje koji odgovaraju važnosti ovog porodičnog trenutka.",
    },
    {
    ...
    <main className="bg-[#fdfbf7] text-[#2f2a24]">
        ...
        <div className="relative mx-auto grid min-h-[78vh] max-w-[1400px] items-center gap-10 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-10">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight text-white md:text-6xl">
              Organizacija krštenja sa elegancijom, toplinom i pažljivo
              osmišljenim detaljima
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-8 text-white/90 md:text-lg">
              Krštenje je jedan od najvažnijih porodičnih trenutaka. Zato
              osmišljavamo proslavu koja spaja nežnu atmosferu, svečani ambijent
          ...
          <div className="lg:justify-self-end">
            <div className="max-w-[430px] rounded-[30px] border border-white/15 bg-white/10 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.18)] backdrop-blur-md">
              ...
              <div className="mt-5 space-y-4">
                {[
                  "Kompletnu organizaciju proslave krštenja",
                  "Svečano i elegantno uređenu atmosferu",
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold leading-tight text-[#26313f] md:text-5xl">
                Krštenje organizovano sa merom, stilom i posebnom pažnjom
              </h2>

              <p className="mt-6 text-base leading-8 text-[#5f5a52] md:text-lg">
                Naš pristup organizaciji krštenja zasniva se na tome da svaki
                detalj bude pažljivo usklađen sa značajem ovog dana. Kreiramo
                proslavu koja je istovremeno svečana, prijatna i estetski
                prelepa, prilagođena vašim željama i potrebama porodice.
              </p>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div className="overflow-hidden rounded-[28px] border border-[#eadfca] bg-white shadow-sm sm:translate-y-10">
                <img
                  src="/krstenje3.jpeg"
                  alt="Detalji sa proslave krštenja"
                  className="h-[260px] w-full object-cover"
                />
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold text-[#26313f] md:text-5xl">
              Šta obuhvata organizacija krštenja
            </h2>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/85 md:text-lg">
              Organizacija krštenja traži pažnju, osećaj za meru i dobru
          ...
          <div className="overflow-hidden rounded-[30px] border border-white/10 bg-white/10 p-3 backdrop-blur-sm">
            <img
              src="/dekoracija2.jpeg"
              alt="Svečana dekoracija za krštenje"
      ...
      <section className="px-6 py-20 md:py-24">
        <div className="mx-auto max-w-6xl rounded-[34px] border border-[#eadfca] bg-[#fcfaf6] px-8 py-14 text-center shadow-sm md:px-14">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-[#26313f] md:text-5xl">
            Hajde da zajedno osmislimo svečano i nezaboravno krštenje
          </h2>
