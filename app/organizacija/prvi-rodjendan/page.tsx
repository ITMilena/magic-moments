export default function PrviRodjendanPage() {
  ...
  const highlights = [
    {
      title: "Pažljivo isplaniran koncept",
      text: "Svaki detalj prilagođavamo vašim željama, temi proslave i atmosferi koju želite da stvorite.",
    },
    {
      title: "Elegantna dekoracija i detalji",
      text: "Od boja, balona i stolova do personalizovanih elemenata, sve je usklađeno u jedinstvenu celinu.",
    },
    {
      title: "Uspomene koje ostaju",
      text: "Fotografija, video i posebni trenuci pažljivo su organizovani kako bi prvi rođendan ostao zauvek zabeležen.",
    },
  ];
    ...
    <main className="bg-[#fdfbf7] text-[#2f2a24]">
        ...
        <div className="relative mx-auto grid min-h-[78vh] max-w-[1400px] items-center gap-10 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-10">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight text-white md:text-6xl">
              Organizacija prvog rođendana sa stilom, emocijom i pažljivo
              osmišljenim detaljima
            </h1>

            <p className="mt-6 max-w-2xl text-base leading-8 text-white/90 md:text-lg">
              Prvi rođendan je poseban trenutak za celu porodicu. Zato
              osmišljavamo proslavu koja spaja toplinu, eleganciju i radost —
              od prostora i dekoracije do zabave, fotografije i svakog važnog
              detalja.
            </p>
            ...
            <div className="max-w-[430px] rounded-[30px] border border-white/15 bg-white/10 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.18)] backdrop-blur-md">
              ...
              <div className="mt-5 space-y-4">
                {[
                  ...
                  "Usklađen vizuelni identitet proslave",
                  "Pouzdane saradnike i koordinaciju",
          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold leading-tight text-[#26313f] md:text-5xl">
                Prvi rođendan koji izgleda nežno, elegantno i potpuno
                usklađeno
              </h2>

              <p className="mt-6 text-base leading-8 text-[#5f5a52] md:text-lg">
                Naš cilj nije samo da organizujemo događaj, već da stvorimo
                atmosferu koja će biti prijatna, topla i vizuelno prelepa.
                Svaki prvi rođendan planiramo tako da bude prilagođen vašoj
                porodici, prostoru, broju gostiju i željenom stilu proslave.
              </p>

              <p className="mt-5 text-base leading-8 text-[#5f5a52] md:text-lg">
                Vodimo računa o svakom segmentu — od odabira prostora, teme i
                dekoracije, do angažovanja saradnika, programa za decu i
                beleženja svih dragocenih trenutaka.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-base leading-8 text-[#635c51] md:text-lg">
              Sve što je potrebno za skladnu, lepu i bezbrižno organizovanu
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight md:text-5xl">
              Vi uživate u trenutku, a mi vodimo računa o svemu ostalom
            </h2>
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/85 md:text-lg">
              Znamo koliko vam znači da prvi rođendan bude bez stresa, lepo
              organizovan i vizuelno poseban. Zato preuzimamo planiranje,
              koordinaciju i detalje, kako biste se vi posvetili porodici,
              gostima i najlepšim trenucima.
            </p>
          </div>
      ...
      <section className="px-6 py-20 md:py-24">
        <div className="mx-auto max-w-6xl rounded-[34px] border border-[#eadfca] bg-[#fcfaf6] px-8 py-14 text-center shadow-sm md:px-14">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-[#26313f] md:text-5xl">
            Hajde da zajedno osmislimo savršen prvi rođendan
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-[#5f5a52] md:text-lg">
            Javite nam svoju ideju, broj gostiju i željeni stil proslave, a mi
            ćemo pripremiti koncept koji spaja eleganciju, toplinu i
