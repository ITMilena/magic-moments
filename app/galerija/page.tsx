...
const dekoracijeSlike = [
  ...
  // NOVE
  { src: "/dekoracija5.jpeg", alt: "Dekoracija 5" },
  { src: "/dekoracija6.jpeg", alt: "Dekoracija 6" },
  { src: "/dekoracija7.jpeg", alt: "Dekoracija 7" },
  { src: "/dekoracija8.jpeg", alt: "Dekoracija 8" },
  { src: "/dekoracija9.jpeg", alt: "Dekoracija 9" },
  { src: "/dekoracija10.jpeg", alt: "Dekoracija 10" },
  { src: "/dekoracija11.jpeg", alt: "Dekoracija 11" },
  { src: "/dekoracija12.jpeg", alt: "Dekoracija 12" },
  { src: "/dekoracija13.jpeg", alt: "Dekoracija 13" },
  { src: "/dekoracija14.jpeg", alt: "Dekoracija 14" },
  { src: "/dekoracija15.jpeg", alt: "Dekoracija 15" },
  { src: "/dekoracija16.jpeg", alt: "Dekoracija 16" },
  { src: "/dekoracija17.jpeg", alt: "Dekoracija 17" },
  { src: "/dekoracija18.jpeg", alt: "Dekoracija 18" },
  { src: "/dekoracija19.jpeg", alt: "Dekoracija 19" },
  { src: "/dekoracija20.jpeg", alt: "Dekoracija 20" },
  { src: "/dekoracija21.jpeg", alt: "Dekoracija 21" },
  { src: "/dekoracija22.jpeg", alt: "Dekoracija 22" },
  { src: "/dekoracija23.jpeg", alt: "Dekoracija 23" },
];
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {dekoracijeSlike.map((slika, index) => (
              <button
                ...
                className="group overflow-hidden rounded-[18px] border border-[#eadfca] bg-white text-left shadow-sm transition hover:-translate-y-1 hover:shadow-md"
              >
      ...
      {selectedImage && (
        ...
        >
          <button
            type="button"
            onClick={() => setSelectedImage(null)}
            className="absolute right-4 top-4 flex h-11 w-11 items-center justify-center rounded-full bg-white/90 text-2xl text-[#26313f] shadow-md transition hover:bg-white"
          ...
          >
            <img
              ...
              className="max-h-[85vh] w-auto max-w-full rounded-[20px] object-contain shadow-2xl"
            />
